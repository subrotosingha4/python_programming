# -*- coding: utf-8 -*-
"""Datacamp-Python-Programmer-Python Data Science Toolbox-part-5.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1GUr3J1CkFpQ3tJu8FDoo9ZOqcGI0LDfQ

# Error handling in data science
- two ways:
- 1. use try: exception:
- 2. use explicitely raise keyword then assign error such as ValueError
